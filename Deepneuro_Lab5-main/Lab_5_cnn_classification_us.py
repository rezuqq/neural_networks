...
train_dataset = torchvision.datasets.ImageFolder(root=r'C:\Users\rezuqq\Documents\нейронка\lb5\data\train', transform=data_transforms)
test_dataset = torchvision.datasets.ImageFolder(root=r'C:\Users\rezuqq\Documents\нейронка\lb5\data\test', transform=data_transforms)
